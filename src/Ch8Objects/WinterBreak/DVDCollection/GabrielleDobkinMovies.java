...
public class GabrielleDobkinMovies {
    ...
    public static void main(String[] args) {/*
        Ch8Objects.WinterBreak.DVDCollection.Ch8Objects.WinterBreak.DVDCollection.GabrielleDobkinDVDCollection movies = new GabrielleDobkinDVDCollection(new ArrayList<>(), 0,0);
